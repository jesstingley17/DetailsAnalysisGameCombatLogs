...
interface ItemConnectorProps {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    nextStep?: any;
    previouslyStepIndex?: number;
    nextStepIndex?: number;
}

const ItemConnector: React.FC<ItemConnectorProps> = ({ connectorType, previouslyStep = null, nextStep = null, previouslyStepIndex = 0, nextStepIndex = 0 }) => {
